...
public class perpus {
    ...
    private String[][] filsafat = { { "Meditasi", "Marcus Aurelius", "208", "186", "Modern Library" },
            { "Republik", "Plato", "384", "380 SM", "Hackett Publishing Company" },
    ...
    private String[][] agama = {
            { "Merebut Kembali Surga: Mengapa Orang Kristen Harus Berperan dalam Politik", "Os Guinness",
                    "288",
    ...
    private String[][] psikologi = { { "Thinking, Fast and Slow", "Daniel Kahneman", "512", "2011",
            "Farrar, Straus and Giroux" },
            { "The Power of Habit: Why We Do What We Do in Life and Business",
                    "Charles Duhigg", "288", "2012", "Random House" },
            { "Man's Search for Meaning", "Viktor E. Frankl",
                    "160", "1946", "Beacon Press" },
            { "The Gift of Therapy", "Irvin D. Yalom", "304", "2002",
                    "HarperCollins" },
    ...
    private String[][] fiksi = { { "The Chronicles of Narnia (series)", "C.S. Lewis", "Varies", "1950-1956",
            "HarperCollins" },
            { "The Percy Jackson & the Olympians (series)", "Rick Riordan", "Varies",
                    "2005-2009", "Hyperion Books for Young Readers" },
            { "A Song of Ice and Fire (series)",
                    "George R.R. Martin", "Varies", "1996-present", "Bantam Books" },
    ...
    public static int hitungjumlahbuku(String[][] daftarbuku) {
